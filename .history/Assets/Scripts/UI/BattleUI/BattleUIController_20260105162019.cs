...
namespace NecromancersRising.UI
{
    public class BattleUIController : MonoBehaviour
    {
        ...
        private Dictionary<BattleEntity, VisualElement> _partyUIElements = new Dictionary<BattleEntity, VisualElement>();
       ...
       public void UpdatePartyDisplay(List<BattleEntity> partyMembers)
        {
            ...
            _partyUIElements.Clear(); // Clear the tracking dictionary
            ...
            for (int i = 0; i < Mathf.Min(3, partyMembers.Count); i++)
            {
                ...
                _partyUIElements[member] = partyContainer; // Track the UI element for this entity
            }
        }
